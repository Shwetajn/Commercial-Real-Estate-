...
export default function AdminTaskDetailPage() {
  ...
  const [comments, setComments] = useState<any[]>([
    { id: 1, author: "System Auto", text: "Task automatically generated and assigned based on workflow rules.", time: "Yesterday, 4:30 PM", isInternal: true }
  ]);
  ...
  if (!task) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center h-[calc(100vh-4rem)] bg-slate-50">
        ...
        <Button variant="outline" onClick={() => router.push('/admin/task-management')}>Return to Tasks</Button>
      </div>
    );
  }
    ...
    <div className="flex-1 overflow-y-auto bg-slate-50 p-6 h-[calc(100vh-4rem)]">
      <div className="max-w-5xl mx-auto space-y-6 pb-20 animate-in fade-in duration-500">
        ...
        <div className="flex items-center gap-4 mb-2">
          <Button variant="ghost" size="icon" onClick={() => router.push('/admin/task-management')} className="rounded-full shrink-0 bg-white shadow-sm border border-slate-200 hover:bg-slate-100">
